...
const FooterContent = ({}) => (
    <FooterLayout>
        <div >
          <footer class="pv6 ph2 tc-l">
            <a class="link near-black hover-silver dib mh3 tc" href="https://github.com/" title="GitHub">
            ...
            <a class="link hover-silver near-black dib mh3 tc" href="http://slack.com" title="Slack">
            ...
            <a class="link hover-silver near-black dib mh3 tc" href="https://twitter.com/" title="Twitter">
            ...
            <p class="f6"><span class="mt3 dib mr4 mr5-ns">©2048 Your site, Inc.</span>
              <a class="link navy  hover-blue inline-flex items-center" href="/terms">Terms</a> /
              <a class="link navy  hover-blue inline-flex items-center" href="/privacy"> Privacy </a> /
              <a class="link navy  hover-blue inline-flex items-center" href="#">hi@yourcompany.com </a>
            </p>
          </footer>
