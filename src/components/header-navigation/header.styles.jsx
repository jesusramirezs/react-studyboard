...
export const OptionLink = styled.a.attrs({ className: 'link dim black dib mr3 pointer' })``

export const SimpleButton = styled.a.attrs({ className: 'f6 dib black bg-animate hover-bg-black hover-white no-underline pv2 ph4 br-pill ba b--black-20 pointer' })``

export const SimpleOpenPanel = styled.a.attrs({ className: 'navy f6 br-pill bg-light-blue no-underline  ba b--light-gray grow pv2 ph3 dib mr3 pointer' })``
